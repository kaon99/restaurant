...
public class BillDaoImpl implements BillDao {
    ...
    public Bill create(Bill entity) {
        try (Connection connection = ConnectionPool.getDataSource().getConnection();
             PreparedStatement statement = connection.prepareStatement(QueriesResourceManager.getProperty("bill.create"), Statement.RETURN_GENERATED_KEYS)) {
    ...
    public Bill findById(int id) {
        try (Connection connection = ConnectionPool.getDataSource().getConnection();
             PreparedStatement statement = connection.prepareStatement(QueriesResourceManager.getProperty("bill.find.by.id"))) {
            Bill bill = null;
    ...
    public List<Bill> findAll() {
        try (Connection connection = ConnectionPool.getDataSource().getConnection();
             PreparedStatement statement = connection.prepareStatement(QueriesResourceManager.getProperty("bill.find.all"))) {
            ResultSet resultSet = statement.executeQuery();
    ...
    public void update(Bill entity) {
        try (Connection connection = ConnectionPool.getDataSource().getConnection();
             PreparedStatement statement = connection.prepareStatement(QueriesResourceManager.getProperty("bill.update"))) {
    ...
    public void delete(int id) {
        try (Connection connection = ConnectionPool.getDataSource().getConnection();
             PreparedStatement statement = connection.prepareStatement(QueriesResourceManager.getProperty("bill.delete"))) {
            statement.setInt(1, id);
            statement.executeUpdate();
    ...
    public void createBillWithSum(int orderId) {
        try (Connection connection = ConnectionPool.getDataSource().getConnection();
             PreparedStatement statement = connection.prepareStatement(QueriesResourceManager.getProperty("bill.find.sum"));
             PreparedStatement statementInsert = connection.prepareStatement(QueriesResourceManager.getProperty("bill.create"))) {
    ...
    public void pay(int billID, int status) {
        try (Connection connection = ConnectionPool.getDataSource().getConnection();
             PreparedStatement statement = connection.prepareStatement(QueriesResourceManager.getProperty("bill.pay"))) {
    ...
    public List<Bill> unpaidList(int userId) {
        try (Connection connection = ConnectionPool.getDataSource().getConnection();
             PreparedStatement statement = connection.prepareStatement(QueriesResourceManager.getProperty("bill.paid.list"))) {
